...
% =========================================================================
        ...
        function obj = legend(obj)
            if isequal(obj.Type, 'Line')
                obj.LgdHdl = legend(obj.ax, [obj.PatchHdlL], obj.ClassName, ...
                    'FontSize', 10, 'Location', 'best', 'Tag', 'SRClagend', ...  % 设置字体大小为 10
                    'Orientation', 'horizontal', 'NumColumns', obj.ClassNum);
            else
                obj.LgdHdl = legend(obj.ax, [obj.PatchHdlP], obj.ClassName, ...
                    'FontSize', 10, 'Location', 'best', 'Tag', 'SRClagend', ...  % 设置字体大小为 10
                    'Orientation', 'horizontal', 'NumColumns', obj.ClassNum);
            end
        end
